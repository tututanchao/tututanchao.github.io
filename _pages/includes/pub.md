...
### 📰 Journal Papers
- `2026 IEEE/CAA Journal of Automatica Sinica` Generative Label Enhancement via Renormalization Group, **Chao Tan\***, Sheng Chen, Mengjiao Kai, Shangce Gao, Xin Geng**<span style="color: red;">(CAA A+, 中科院一区TOP, IF=18.3)</span>**
...
- `2024 The 34th International Joint Conference on Neural Network` [Imbalanced Label Enhancement Based on Variational Information Bottleneck](https://ieeexplore.ieee.org/document/10650759), Anning Song, **Chao Tan\***, Jiaxi Zhang, Zilong Xu**<span style="color: red;">(CCF C)</span>**
